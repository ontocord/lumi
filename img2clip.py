...
def save_clip_batch(image_features_mmap, decomposed_image_features_mmap,  imgs, idxs, mmap_len, cls_weight=.9,):
  with torch.no_grad():
...
def create_img2clip_data_mmaps(laion_df=None, image_size=100, shard_range=None, download_images=True):
  md5_hash ={}
  if laion_df is None:
