        ...
        for didx, text in enumerate(dat):
            ...
            with torch.no_grad():
              ...
              if sim1 > score_cutoff:    
                ...
                matched_output, cropped_images = get_sent_to_img(matched_sentence, img, get_cropped_images=True, other_sent_arr=['diagram of lines and networks'] + ([] if ' clock ' in matched_sentence else ['a clock']) + ['abstract art'] )
